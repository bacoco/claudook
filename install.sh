...
echo -e "  ${YELLOW}/claudook/help${NC}           - Show all available commands"
echo -e "  ${YELLOW}/claudook/status${NC}         - Check current status"
echo -e "  ${YELLOW}/claudook/choices-enable${NC}  - Turn on A/B/C options"
echo -e "  ${YELLOW}/claudook/choices-disable${NC} - Turn off A/B/C options"
echo -e "  ${YELLOW}/claudook/tests-enable${NC}    - Turn on mandatory testing"
echo -e "  ${YELLOW}/claudook/tests-disable${NC}   - Turn off mandatory testing"
echo ""
...
echo -e "  • Files are in ${YELLOW}$INSTALL_DIR/.claude/${NC}"
echo -e "  • Settings are project-specific"
echo -e "  • Won't affect other Claude projects"
echo -e "  • Works immediately (no restart needed)"
echo ""